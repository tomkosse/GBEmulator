...
namespace GBEmulator
{
    public class Instructions
    {
        ...
        private void LDCA(Processor processor, Memory memory)
        {
            memory.WriteByte(0xFF00 + processor.Register.C, processor.Register.A);
        }
        ...
        private void LDDHLA(Processor processor, Memory memory)
        {
            ...
            processor.Register.IncrementProgramCounter(); // Is this right? =/
